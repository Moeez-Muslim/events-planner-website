      ...
      <div className="row px-0" style={{ minHeight: '50vh' }}>
        ...
        <div className="col-md-4 col-sm-12 d-flex align-items-center" style={{ backgroundColor: 'rgba(156, 86, 154, 0.5)' }}>
          <div className="mt-4 mx-auto" style={{ maxWidth: '400px' }}>
            <h1 style={{ color: 'purple' }}><b>Signup</b></h1>
            <form>
              <div className="mb-1">
              ...
              <div className="d-grid gap-2 col-12 mx-auto">
                <button className="btn btn btn-outline-danger" type="button">Signup</button>
                <button className="btn btn-danger mb-4" type="button">Back to login</button>
              </div>
            </form>
          </div>
        </div>
